...
foreach ($files as $file) {
    ...
    match (true) {
        str_contains($file, determineSeparator('src/queue.php')) => rename($file, determineSeparator('./src/' . $className . '.php')),
        str_contains($file, determineSeparator('src/JiraQueueTileServiceProvider.php')) => rename($file, determineSeparator('./src/' . $className . 'ServiceProvider.php')),
        str_contains($file, determineSeparator('src/Facades/queue.php')) => rename($file, determineSeparator('./src/Facades/' . $className . '.php')),
        str_contains($file, determineSeparator('src/Commands/FetchDataFromJiraQueueCommand.php')) => rename($file, determineSeparator('./src/Commands/' . $className . 'Command.php')),
        ...
        str_contains($file, determineSeparator('config/queue.php')) => rename($file, determineSeparator('./config/' . $packageSlugWithoutPrefix . '.php')),
